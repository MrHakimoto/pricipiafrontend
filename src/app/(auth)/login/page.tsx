            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 flex items-center justify-center text-white relative overflow-hidden">
                ...
                <div className="w-full max-w-md z-10 space-y-6">
                    <div className="flex justify-center mb-4">
                        <div className="rounded-full w-24 h-24 flex items-center justify-center overflow-hidde">
                            <img
                    ...
                    <div className="flex gap-2">
                        <div className="flex-1">
                            <button
                                ...
                                type="button"
                                disabled={loading}
                                className="w-full bg-[#1B1F27] text-lg text-white font-bold rounded-lg px-8 py-4 flex items-center justify-center gap-2 text-sm hover:bg-gray-700 cursor-pointer"
                            >
                        ...
                        <div className="flex-1">
                            <Link href="/login/login-magico">
                                <button
                                    type="button"
                                    className="w-full cursor-pointer text-lg text-white font-bold bg-[#1B1F27] rounded-lg px-8 py-4 flex items-center justify-center gap-2 text-sm hover:bg-gray-700"
                                >
